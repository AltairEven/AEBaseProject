...
- (id)init
{
    ...
    if (self) {
		...
		centerView = [[UIView alloc] initWithFrame: CGRectMake(0.0, 0.0, PIC_WIDTH, PIC_HEIGHT)];
...
- (void)show
{
    ...
    indicatorView = [[GActivityIndicatorView alloc] initWithFrame: CGRectMake(0.0, 0.0,PIC_WIDTH, PIC_HEIGHT)];
    indicatorView.delegate = self;
    [indicatorView setCenter: CGPointMake(PIC_WIDTH / 2, PIC_HEIGHT / 2)];

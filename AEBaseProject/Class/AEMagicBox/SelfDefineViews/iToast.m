...
//	CGSize textSize = [_text sizeWithFont:font constrainedToSize:CGSizeMake(200, 100)];
    CGSize textSize = CGSizeMake(SCREEN_WIDTH / 2, [_text sizeOfMaxBoundingWidth:SCREEN_WIDTH / 2 withLineBreakMode:NSLineBreakByCharWrapping font:font].height);
...
//        CGSize titleTextSize = [_title sizeWithFont:font constrainedToSize:TEXT_MAX_SIZE];
        CGSize titleTextSize = CGSizeMake(SCREEN_WIDTH / 2, [_text sizeOfMaxBoundingWidth:SCREEN_WIDTH / 2 withLineBreakMode:NSLineBreakByCharWrapping font:font].height + 20);
